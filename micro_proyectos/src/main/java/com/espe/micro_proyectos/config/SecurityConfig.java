...
import com.espe.micro_proyectos.filters.JwtRequestFilter;
import com.espe.micro_proyectos.clients.AuthClient;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/proyectos/**").hasAnyRole("ADMIN", "LIDER", "EMPLEADO")
    ...
    public NoOpPasswordEncoder passwordEncoder() {
        return (NoOpPasswordEncoder) NoOpPasswordEncoder.getInstance(); // Usamos NoOpPasswordEncoder para no encriptar contraseñas
    }
